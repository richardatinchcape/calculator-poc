...
`reference-prd.md`, `reference-trd.md`, `reference-persona.md`, `reference-persona-generate.md`, `reference-consult.md`, `reference-chat.md`, `reference-workflow-personas.md` (Requirements), `reference-epic.md`, `reference-epic-sections.md`, `reference-story.md`, `reference-story-sections.md`, `reference-bug.md`, `reference-cr.md` (Specifications), `reference-architecture.md` (Architecture), `reference-code.md` (Code, Test), `reference-refactor.md` (Refactoring, Review), `reference-review.md` (Unified document review), `reference-audit.md` (Adversarial audit harness), `reference-project.md` (Project orchestration), `reference-agentic-lessons.md` (Production lessons for agentic execution), `reference-agent-prompt-template.md` (Agentic wave prompt structure), `reference-operator-heuristics.md` (Cross-cutting operator patterns: memory-drift, incident localisation, release-gate), `reference-tsd.md`, `reference-test-spec.md`, `reference-test-automation.md` (Test artifacts), `reference-test-best-practices.md` (Test pitfalls and anti-patterns), `reference-test-validation.md` (Validation workflows), `reference-test-e2e-guidelines.md` (E2E patterns), `reference-upgrade.md` (Schema migration), `reference-reconcile.md` (Status reconciliation), `reference-outputs.md` (Status transitions and the canonical story/epic completion cascades), `reference-repo-map.md` (AST repo indexer), `reference-verify.md` (Executable AC verifier DSL), `reference-github-sync.md` (GitHub Issues two-way sync), `reference-scripts.md` (Skill-internal scripts convention - the hub; its split catalogue pages: `reference-scripts-create.md`, `reference-scripts-verify.md`, `reference-scripts-review.md`, `reference-scripts-upgrade.md`, `reference-scripts-domain.md`), `reference-doctrine.md` (Operating doctrine), `reference-deploy-readiness.md` (Deploy readiness patterns), `reference-deploy.md` (Deploy last-mile workflow), `reference-rfc.md` (RFC design exploration), `reference-retro.md` (Retro workflow: content-checked close gate, the disposition rule, lesson extraction), `reference-plan-files.md` (Plan-file lifecycle), `reference-sprint.md` (Sprint / Goal-Driven Development loop), `reference-pvd.md` (Product Vision Document, multi-repo product layer), `reference-skill-update.md` (Version check and upgrade)
